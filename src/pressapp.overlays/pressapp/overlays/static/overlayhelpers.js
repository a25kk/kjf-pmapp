...
(function ($) {
    ...
    $().ready(function () {
        ...
        $('a.popoverForm').prepOverlay({
            ...
            // Add this to a link or button to make it close the overlay e.g.
            // on cancel without reloading the page
            closeselector: '.overlayCloseAction, [name=form.button.Cancel], [name=form.buttons.cancel]',
            formselector: 'form.overlayForm,form.edit-form,#document-base-edit,form#form',
            noform: 'redirect', // XXX : this will probably need to get smarter
            config: {
                closeOnClick: false,
                top: 130,
                mask: {
