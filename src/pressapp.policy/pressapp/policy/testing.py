...
class PressAppPolicy(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        xmlconfig.file('configure.zcml', pressapp.policy, context=configurationContext)
    ...
    def setUpPloneSite(self, portal):
        applyProfile(portal, 'pressapp.policy:default')

PRESSAPP_POLICY_FIXTURE = PressAppPolicy()
PRESSAPP_POLICY_INTEGRATION_TESTING = IntegrationTesting(bases=(PRESSAPP_POLICY_FIXTURE,), name="PressApp:Integration")
