/* This script should be the default one from CMFPlone/skins/plone_ecmascript.js
 * Since the file isn't customisable in any Z3-way (as far as i know) it needs to be here.
